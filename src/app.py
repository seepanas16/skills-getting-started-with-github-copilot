...
activities = {
    ...
    "Soccer Team": {
        "description": "Team practices and competitive school soccer matches",
        "schedule": "Mondays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["alex@mergington.edu", "jordan@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim training and aquatic fitness for students of all levels",
    ...
    "Art Studio": {
        ...
        "max_participants": 14,
        "participants": ["aubrey@mergington.edu", "maria@mergington.edu"]
    },
    "Drama Club": {
        "description": "Acting workshops and theatrical performances throughout the year",
        "schedule": "Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 20,
        "participants": ["jack@mergington.edu", "lena@mergington.edu"]
    },
    "Debate Team": {
    ...
    "Science Club": {
        "description": "Hands-on experiments and science fair preparation for curious minds",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
